...
module "prod_iam" {
  ...
  depends_on = [module.prod_aks, module.prod_keyvault]
}
...
module "prod_acr" {
  ...
  user_assigned_identity_id = module.prod_iam.user_assigned_identity_id
  vault_key_id = module.prod_keyvault.vault_id_output
  user_assigned_identity_name = module.prod_iam.user_assigned_identity_name

  depends_on = [module.prod_iam, module.prod_keyvault]
}
